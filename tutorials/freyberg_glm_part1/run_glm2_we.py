...
# get weights
pst_we = pyemu.Pst(os.path.join(t_d, 'freyberg_mf6.pst'))
obs_we = pst_we.observation_data.weight
...
pst.observation_data.weight = obs_we
...
# master
num_workers = 10
m_d=os.path.join('master_glm_2_we')
