...
def geostat_interpolate(X,Y,interp_data, data_df):
    ...
    :param interp_data: dataframe of interpolation data generated by pyemu.geostats.OrdinaryKrige.calc_factors()
    ...
    for cp in interp_data.index:
        # a lot going on in the next line! Get the locations from sample_df of the names for current point (cp)
